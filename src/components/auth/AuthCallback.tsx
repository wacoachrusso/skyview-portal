...
const AuthCallback = () => {
  ...
  useEffect(() => {
    const processCallback = async () => {
      console.log(
        "AuthCallback: Processing started with URL params:",
      ...
      try {
        ...
        if (sessionId) {
          console.log(
            "AuthCallback: Stripe payment callback detected with session ID:",
            sessionId
          );
        ...
        if (provider === "google" || type === "oauth") {
          console.log(
            "AuthCallback: Detected OAuth callback with provider:",
            provider || "unknown"
          );
          setIsOAuthFlow(true);
        ...
        if (email && token_hash) {
          ...
          console.log(
            "AuthCallback: Session found, proceeding with handleCallback"
          );
