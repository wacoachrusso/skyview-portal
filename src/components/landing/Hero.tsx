...
export function Hero() {
  return (
    <div className="relative bg-hero-gradient py-12 overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
          <div className="w-full lg:w-1/2 text-center lg:text-left">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-4 leading-tight animate-fade-up" style={{ animationDelay: "0.1s" }}>
              Navigate Your Contract <br className="hidden md:block" />
              With Confidence
            </h1>
            <p className="text-lg text-gray-200 mb-6 max-w-2xl mx-auto lg:mx-0 animate-fade-up" style={{ animationDelay: "0.2s" }}>
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center lg:justify-start animate-fade-up" style={{ animationDelay: "0.3s" }}>
              <Button 
                asChild 
                size="lg"
                className="bg-brand-gold hover:bg-brand-gold/90 text-brand-navy font-semibold px-6"
              >
              ...
              <Button
                ...
                size="lg"
                variant="outline"
                className="border-2 border-white/20 text-white hover:bg-white/10 font-semibold px-6"
              >
          ...
          <div className="w-full lg:w-1/2 flex items-center justify-center animate-fade-up" style={{ animationDelay: "0.4s" }}>
            <div className="relative w-full max-w-lg">
              ...
              <div className="relative bg-gradient-to-b from-slate-800/90 to-slate-900/90 p-6 rounded-xl shadow-2xl border border-white/10 backdrop-blur-sm">
                <img 
                  src="/lovable-uploads/fbb674f2-9c00-4170-8499-9be00873e9ad.png" 
