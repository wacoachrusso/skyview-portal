...
const Refunds = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-brand-navy via-background to-brand-slate">
      ...
      <main className="container mx-auto px-4 py-8 prose prose-invert max-w-4xl">
        <h1 className="text-3xl font-bold text-white mb-8">Refund and Cancellation Policy</h1>

        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-white">1. Subscription Refunds</h2>
          ...
          <div className="ml-6">
            <h3 className="text-xl font-medium text-white">Monthly Subscriptions:</h3>
            ...
            <h3 className="text-xl font-medium text-white mt-4">Annual Subscriptions:</h3>
            <ul className="list-disc ml-6 text-gray-300">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-white">2. Cancellation Process</h2>
          <ul className="list-disc ml-6 text-gray-300">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-white">3. Non-Refundable Items</h2>
          <p className="text-gray-300">The following services are non-refundable:</p>
          <ul className="list-disc ml-6 text-gray-300">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-white">4. Refund Exceptions</h2>
          <p className="text-gray-300">Refunds may be considered in exceptional circumstances, such as:</p>
          <ul className="list-disc ml-6 text-gray-300">
          ...
          <p className="text-gray-300 mt-4">
            Please email <a href="mailto:refunds@skyguide.site" className="text-brand-gold hover:underline">refunds@skyguide.site</a> with 
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-300">
            ...
            <br />
            <strong>Email:</strong> <a href="mailto:refunds@skyguide.site" className="text-brand-gold hover:underline">refunds@skyguide.site</a>
          </p>
        </section>
      </main>
    </div>
